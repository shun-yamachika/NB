...
min_bounces = 2
max_bounces= 20
two_node_RB = MultiNodeRB(n_nodes=n_nodes,min_bounces = min_bounces,max_bounces = max_bounces,n_samples =50)
...
with open('AB_decay_50samples.pickle', 'wb') as f:
  pk.dump({"decay data":two_node_RB.get_fidelity(),"endpoints":[min_bounces,max_bounces]},f)

print(f"Simulation complete. Data saved to AB_decay_50samples.pickle")
